      ...
      <div className='relative lg:mb-[110px] md:mb-20 sm:mb-16 mb-10 overflow-x-clip'>
          <div className="container max-w-[1232px] px-3 mx-auto bg-[#F7FAFE]">
              <div className="flex justify-center items-center flex-col" data-aos="zoom-in">
                  <h2 data-aos="zoom-in" className='md:pt-20 sm:pt-12 pt-8 text-[#2E2E2E] max-w-[1024px] text-center font-poppins xl:text-[64px] lg:text-6xl md:text-[52px] sm:text-[40px] text-4xl font-semibold md:leading-[137.5%] '>We're here to make your website awesome.</h2>
                  <a href="https://www.whatsapp.com/">
                      <button className='text-white hover:bg-transparent hover:border-[#B00000] hover:text-[#B00000] border-transparent border-[2px] duration-500 hover:shadow-none group rounded-[8px] md:mt-10 sm:mt-8 mt-4 md:mb-[88px] sm:mb-16 mb-10 font-poppins py-3 px-4 flex text-sm font-normal leading-[171.429%] bg-[#B00000]'><span className='pr-2'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
